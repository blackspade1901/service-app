'use client'
import { Heart, Star, MapPin, DollarSign, Phone, Trash2, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#fafafa] py-10 overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6 transition-all duration-1000 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
          ...
          <Link
            href="/"
            className="flex items-center gap-2 px-8 py-4 bg-slate-900 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-fuchsia-600 transition-all shadow-xl active:scale-90"
          >
