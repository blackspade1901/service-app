  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-500 py-6">
      <div className="max-w-7xl mx-auto px-4 space-y-6">
        ...
        <div className="bg-card/50 backdrop-blur-md rounded-2xl shadow-xl border border-border p-6 animate-in fade-in slide-in-from-top-4 duration-700">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Booking Requests */}
            <section className="bg-card/50 backdrop-blur-md rounded-2xl shadow-lg border border-border p-6 animate-in fade-in slide-in-from-left-4 duration-1000">
            ...
            {/* Today's Schedule */}
            <section className="bg-card/50 backdrop-blur-md rounded-2xl shadow-lg border border-border p-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">
